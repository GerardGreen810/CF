...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2025 a las 17:02:47
...
--
-- Estructura de tabla para la tabla `dialogs`
--
...
--
-- Volcado de datos para la tabla `dialogs`
--

INSERT INTO `dialogs` (`id`, `dialog_key`, `title`, `meta`, `allow_repeat`, `created_at`) VALUES
(1, 'intro_scene_1', 'Introducción - Escena 1', '{\"typing\": true, \"trigger_signal\": \"start_scene_1\"}', 0, '2025-10-17 22:53:19'),
(2, 'door_right_intro', 'Puerta Derecha - Intro', '{\"typing\": true, \"trigger_signal\": \"door_right\"}', 0, '2025-10-17 22:53:19');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dialog_lines`
--
...
CREATE TABLE `dialog_lines` (
  ...
  `text` text NOT NULL,
  `sfx_role` varchar(80) DEFAULT NULL,
  `sfx_path` varchar(255) DEFAULT NULL,
  `choices` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`choices`)),
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `dialog_lines`
--

INSERT INTO `dialog_lines` (`id`, `dialog_id`, `ordering`, `speaker`, `text`, `sfx_role`, `sfx_path`, `choices`, `created_at`) VALUES
(1, 1, 1, 'Coatli', '¿Qué es este lugar...? Parece un bosque encendido.', 'sfx_line_01', NULL, NULL, '2025-10-17 22:53:20'),
(2, 1, 2, '??', 'No te preocupes. Todo estará bien.', NULL, 'sfx/whisper.mp3', NULL, '2025-10-17 22:53:20'),
(3, 1, 3, 'Coatli', '—Respira— OK. Vamos.', 'sfx_line_02', NULL, NULL, '2025-10-17 22:53:20'),
(4, 2, 1, 'Coatli', 'La puerta de la derecha está abierta...', NULL, NULL, NULL, '2025-10-17 22:53:20'),
(5, 2, 2, 'Narrador', 'Un susurro te invita a entrar.', NULL, NULL, NULL, '2025-10-17 22:53:20');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dialog_triggers`
--

CREATE TABLE `dialog_triggers` (
  `id` int(10) UNSIGNED NOT NULL,
  `dialog_id` int(10) UNSIGNED NOT NULL,
  `trigger_signal` varchar(160) NOT NULL,
  `active` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `dialog_triggers`
--

INSERT INTO `dialog_triggers` (`id`, `dialog_id`, `trigger_signal`, `active`, `created_at`) VALUES
(1, 1, 'start_scene_1', 1, '2025-10-17 22:53:20'),
(2, 2, 'door_right', 1, '2025-10-17 22:53:20');
...
(8, 1, 1, '{\"scene_id\":1,\"progress\":{},\"created_at\":\"2025-10-17T04:22:18+02:00\"}', '2025-10-17 02:22:18', '2025-10-17 02:22:18');
...
(2, 'scene_2', 'Escena 2', 'Exterior - escena 2', 'side_scroll', '{\"dialog_on_load\":\"door_right_intro\"}', 2, '2025-10-14 23:03:09'),
...
(1, 'UsuarioDeEjemplo', NULL, '$2y$10$6ot59yeYCuaogdi6uWtk8O31HA3THUjTOr9O6biwFsWE95vad87va', 0, '2025-10-14 23:22:46', '2025-10-17 02:21:46');
...
--
-- Indices de la tabla `dialogs`
--
ALTER TABLE `dialogs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `dialog_key` (`dialog_key`);

--
-- Indices de la tabla `dialog_lines`
--
ALTER TABLE `dialog_lines`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_dialog_lines_dialog_order` (`dialog_id`,`ordering`);

--
-- Indices de la tabla `dialog_triggers`
--
ALTER TABLE `dialog_triggers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_dialog_triggers_dialog` (`dialog_id`),
  ADD KEY `idx_dialog_triggers_signal` (`trigger_signal`,`active`);
...
--
-- AUTO_INCREMENT de la tabla `dialogs`
--
ALTER TABLE `dialogs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `dialog_lines`
--
ALTER TABLE `dialog_lines`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `dialog_triggers`
--
ALTER TABLE `dialog_triggers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Filtros para la tabla `dialog_lines`
--
ALTER TABLE `dialog_lines`
  ADD CONSTRAINT `fk_dialog_lines_dialog` FOREIGN KEY (`dialog_id`) REFERENCES `dialogs` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `dialog_triggers`
--
ALTER TABLE `dialog_triggers`
  ADD CONSTRAINT `fk_dialog_triggers_dialog` FOREIGN KEY (`dialog_id`) REFERENCES `dialogs` (`id`) ON DELETE CASCADE;
